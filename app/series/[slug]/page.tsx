      ...
      <section className="relative overflow-hidden rounded-2xl border border-border">
        ...
        <div className="absolute inset-0 p-6 md:p-10">
          <div className="mb-3 flex flex-wrap items-center gap-2">
            <span className="rounded-full bg-primary px-3 py-1 text-xs font-bold text-black">Series</span>
          ...
          <Link href={`/series/watch/${content.slug}`} className="mt-5 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-3 text-sm font-bold text-black shadow-[0_0_30px_rgba(245,197,66,0.2)]">
